...
const Banner = () => {
    return (
        <div>
            <div className="hero bg-[#9538E2] relative top-20   rounded-3xl py-10 container mx-auto">
                <div className="hero-content text-center">
                    <div className="max-w-md py-16 text-white">
                        <h1 className="  font-bold">Upgrade Your Tech Accessorize with <br /> Gadget Heaven Accessories</h1>
                        <p className="py-6">
